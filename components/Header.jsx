  ...
  return (
    <>
      {/* <motion.nav
        ...
        initial="hidden"
        whileInView="show"
        className={`h-[112px] relative bg-gray-100`}
      > */}
      <nav className="w-full backdrop-filter backdrop-blur-sm absolute top-0 z-50 pt-8">
        <div className="justify-between px-4 max-md:px-2 mx-auto lg:max-w-7xl md:items-center md:flex">
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <Link
                className="text-3xl max-md:text-xl text-gray-700 font-bold font-mono p-5"
                href="/"
              >
                TUTKU TAYLAN
              </Link>
