...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white rounded-lg p-8 pb-12 mb-8" id="contact">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Contact Me</h3>
      <div className="grid grid-cols-1 gap-4 mb-4">
        <textarea
          value={formData.comment}
          onChange={onInputChange}
          className="p-4 outline-none w-full rounded-md h-40 focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700"
          name="comment"
          placeholder="Comment"
        />
      </div>
      ...
      <div className="mt-8">
        <button
          ...
          className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-purple-900 text-lg font-medium rounded-sm text-white px-8 py-1 cursor-pointer"
        >
          Post Comment
        </button>
        {showSuccessMessage && (
